...
public class HomeActivity extends AppCompatActivity {
    ...
    private void showAddressSelection() {
        ...
        if (destWallet != null)
            rootLayout.removeView(destWallet);
        if (destSaving != null)
            rootLayout.removeView(destSaving);
    ...
    public static class HomeRepository {
        ...
        public java.util.List<FoodMenuItem> getPopularFoods() {
            ...
            list.add(new FoodMenuItem("f_2", "Trà sữa thái", 25000, R.drawable.img_food_bubbletea,
                    "Trà sữa thái xanh trân châu"));
            list.add(new FoodMenuItem("f_3", "Cà phê đen đá", 15000, R.drawable.img_food_coffee,
                    "Cà phê phin truyền thống"));
            list.add(new FoodMenuItem("f_4", "Pizza xúc xích", 89000, R.drawable.img_food_pizza,
                    "Pizza phô mai xúc xích"));
            list.add(new FoodMenuItem("f_5", "Gà cay phô mai", 55000, R.drawable.img_food_chicken,
                    "Gà xào bắp cải phô mai"));
            list.add(new FoodMenuItem("f_6", "Trà đào", 30000, R.drawable.img_food_bubbletea,
        ...
        public java.util.List<FoodMenuItem> getDealFoods() {
            java.util.List<FoodMenuItem> list = new java.util.ArrayList<>();
            list.add(new FoodMenuItem("d_1", "Gà rán truyền thống", 45000, R.drawable.img_food_chicken,
                    "1 miếng gà rán giòn"));
            list.add(new FoodMenuItem("d_2", "Combo gà rán + khoai", 89000, R.drawable.img_food_chicken,
                    "2 miếng gà + khoai tây"));
            list.add(new FoodMenuItem("d_3", "Burger gà giòn", 39000, R.drawable.img_food_chicken,
                    "Burger gà với rau tươi"));
            list.add(new FoodMenuItem("d_4", "Cơm gà sốt cay", 55000, R.drawable.img_food_chicken,
                    "Cơm trắng + gà sốt cay"));
            list.add(new FoodMenuItem("d_5", "Trà sen vàng", 45000, R.drawable.img_food_bubbletea,
                    "Trà ướp sen thơm mát"));
            list.add(new FoodMenuItem("d_6", "Trà đào cam sả", 55000, R.drawable.img_food_bubbletea,
                    "Trà đào tươi mát"));
            list.add(new FoodMenuItem("d_7", "Cà phê sữa đá", 35000, R.drawable.img_food_coffee,
                    "Cà phê phin truyền thống"));
            list.add(new FoodMenuItem("d_8", "Bánh mì chà bông", 25000, R.drawable.img_food_chicken,
                    "Bánh mì nướng giòn"));
            return list;
        }
        ...
        public java.util.List<FoodMenuItem> getCategoryFoods(int categoryIndex) {
            ...
            switch (categoryIndex) {
                case 0:
                    list.add(new FoodMenuItem("c0_1", "Phở Bò Tái Nạm", 45000, R.drawable.img_food_chicken,
                            "Phở bò truyền thống với nước dùng đậm đà"));
                    list.add(new FoodMenuItem("c0_2", "Bún Bò Huế Chả Cua", 55000, R.drawable.img_food_pizza,
                            "Bún bò Huế cay nồng, chả cua dai ngon"));
                    list.add(new FoodMenuItem("c0_3", "Bún Riêu Cua Ốc", 40000, R.drawable.img_food_chicken,
                            "Bún riêu ốc đậu nóng hổi"));
                    list.add(new FoodMenuItem("c0_4", "Hủ Tiếu Nam Vang", 50000, R.drawable.img_food_pizza,
                            "Hủ tiếu tôm thịt, trứng cút"));
                    list.add(new FoodMenuItem("c0_5", "Bún Thịt Nướng", 35000, R.drawable.img_food_chicken,
                            "Bún thịt nướng chả giò"));
                    break;
                case 1:
                    list.add(new FoodMenuItem("c1_1", "Combo Gà Giòn", 89000, R.drawable.img_food_chicken,
                            "2 miếng gà giòn + khoai tây + nước ngọt"));
                    list.add(new FoodMenuItem("c1_2", "Gà Cay Phô Mai", 65000, R.drawable.img_food_chicken,
                            "Gà phủ sốt cay và phô mai chảy"));
                    list.add(new FoodMenuItem("c1_3", "Cơm Gà Xối Mỡ", 45000, R.drawable.img_food_chicken,
                            "Cơm chiên đùi gà góc phần tư"));
                    list.add(new FoodMenuItem("c1_4", "Burger Gà Giòn", 39000, R.drawable.img_food_chicken,
                            "Burger gà kèm rau tươi"));
                    list.add(new FoodMenuItem("c1_5", "Gà Viên Lắc Phô Mai", 40000, R.drawable.img_food_chicken,
                            "Gà viên chiên lắc bột phô mai"));
                    break;
                case 2:
                    list.add(new FoodMenuItem("c2_1", "Trà Sữa Trân Châu", 35000, R.drawable.img_food_bubbletea,
                            "Trà sữa truyền thống, trân châu đen dai"));
                    list.add(new FoodMenuItem("c2_2", "Cà Phê Sữa Đá", 25000, R.drawable.img_food_coffee,
                            "Cà phê phin pha sữa đặc"));
                    list.add(new FoodMenuItem("c2_3", "Trà Đào Cam Sả", 45000, R.drawable.img_food_bubbletea,
                            "Trà đào thơm mát sảng khoái"));
                    list.add(new FoodMenuItem("c2_4", "Sữa Tươi Đường Đen", 40000, R.drawable.img_food_bubbletea,
                            "Sữa tươi dalat milk và đường đen"));
                    list.add(new FoodMenuItem("c2_5", "Sinh Tố Bơ", 45000, R.drawable.img_food_bubbletea,
                            "Sinh tố bơ sáp thơm béo"));
                    break;
                case 3:
                    list.add(new FoodMenuItem("c3_1", "Khoai Tây Chiên", 30000, R.drawable.img_food_pizza,
                            "Khoai tây chiên giòn rắc rong biển"));
                    list.add(new FoodMenuItem("c3_2", "Phô Mai Que", 35000, R.drawable.img_food_pizza,
                            "Phô mai que tẩm bột chiên giòn"));
                    list.add(new FoodMenuItem("c3_3", "Bánh Tráng Trộn", 25000, R.drawable.img_food_pizza,
                            "Bánh tráng trộn khô bò, xoài, trứng cút"));
                    list.add(new FoodMenuItem("c3_4", "Cá Viên Chiên", 30000, R.drawable.img_food_chicken,
                            "Cá viên, tôm viên, bò viên chiên"));
                    break;
                default:
                    list.add(new FoodMenuItem("c_def_1", "Món ăn đang cập nhật", 0, R.drawable.img_food_chicken,
        ...
        public java.util.List<FoodMenuItem> getCategoryFoodsByName(String categoryName) {
            ...
            switch (categoryName) {
                case "Cơm":
                    return getCategoryFoods(0);
                case "Bún\nPhở":
                    return getCategoryFoods(0);
                case "Đồ Ăn\nnhanh":
                    return getCategoryFoods(1);
                case "Đồ nướng\nBBQ":
                    return getCategoryFoods(1);
                case "Cà phê\nTrà sữa":
                    return getCategoryFoods(2);
                case "Ăn vặt\nBánh ngọt":
                    return getCategoryFoods(3);
                case "Bánh mì":
                    return getCategoryFoods(3);
                case "Lẩu":
                case "Hải sản":
        ...
        public java.util.List<com.example.uitpayapp.home.home_models.Restaurant> getRestaurants() {
            ...
            restaurants.add(new com.example.uitpayapp.home.home_models.Restaurant(20L, "KFC", "KFC",
                    android.graphics.Color.parseColor("#E4002B"), "Gà rán\nBurger", java.util.Arrays.asList(
                            new FoodMenuItem("r1_1", "Gà rán truyền thống", 45000, R.drawable.img_food_chicken,
                                    "1 miếng gà rán giòn"),
                            new FoodMenuItem("r1_2", "Combo gà rán + khoai", 89000, R.drawable.img_food_chicken,
                                    "2 miếng gà + khoai tây"),
                            new FoodMenuItem("r1_3", "Burger gà giòn", 39000, R.drawable.img_food_chicken,
                                    "Burger gà với rau tươi"),
                            new FoodMenuItem("r1_4", "Cơm gà sốt cay", 55000, R.drawable.img_food_chicken,
                                    "Cơm trắng + gà sốt cay")),
                    R.drawable.img_food_chicken, 4.8, 1250, 25, "KFC Võ Văn Ngân, Thủ Đức"));

            restaurants.add(new com.example.uitpayapp.home.home_models.Restaurant(17L, "The Coffee House", "TCH",
                    android.graphics.Color.parseColor("#ED692F"), "Cà phê\nTrà sữa", java.util.Arrays.asList(
                            new FoodMenuItem("r3_1", "Cà phê sữa đá", 35000, R.drawable.img_food_coffee,
                                    "Cà phê phin truyền thống"),
                            new FoodMenuItem("r3_2", "Trà đào cam sả", 55000, R.drawable.img_food_bubbletea,
                                    "Trà đào tươi mát"),
                            new FoodMenuItem("r3_3", "Trà sen vàng", 45000, R.drawable.img_food_bubbletea,
                                    "Trà ướp sen thơm mát"),
                            new FoodMenuItem("r3_4", "Bánh mì chà bông", 25000, R.drawable.img_food_chicken,
                                    "Bánh mì nướng giòn")),
                    R.drawable.img_food_coffee, 4.7, 950, 20, "TCH Kha Vạn Cân, Thủ Đức"));

            restaurants.add(new com.example.uitpayapp.home.home_models.Restaurant(45L, "Phúc Long", "PL",
                    android.graphics.Color.parseColor("#006241"), "Cà phê\nTrà sữa", java.util.Arrays.asList(
                            new FoodMenuItem("r2_1", "Trà sen vàng", 45000, R.drawable.img_food_bubbletea,
                                    "Trà ướp sen thơm mát"),
                            new FoodMenuItem("r2_2", "Trà đào cam sả", 55000, R.drawable.img_food_bubbletea,
                                    "Trà đào tươi mát"),
                            new FoodMenuItem("r2_3", "Cà phê sữa đá", 35000, R.drawable.img_food_coffee,
                                    "Cà phê phin truyền thống"),
                            new FoodMenuItem("r2_4", "Bánh mì chà bông", 25000, R.drawable.img_food_chicken,
                                    "Bánh mì nướng giòn")),
                    R.drawable.img_food_bubbletea, 4.6, 850, 15, "Phúc Long Lê Văn Việt, Q9"));

            restaurants.add(new com.example.uitpayapp.home.home_models.Restaurant(61L, "Jollibee", "JB",
                    android.graphics.Color.parseColor("#E31837"), "Gà rán\nBurger", java.util.Arrays.asList(
                            new FoodMenuItem("r3_1", "Gà giòn vui vẻ 1 miếng", 35000, R.drawable.img_food_chicken,
                                    "Gà giòn đặc biệt"),
                            new FoodMenuItem("r3_2", "Combo Jolly 1", 79000, R.drawable.img_food_chicken,
                                    "Gà + cơm + nước"),
                            new FoodMenuItem("r3_3", "Mì Ý sốt bò bằm", 55000, R.drawable.img_food_pizza,
                                    "Mì Ý với sốt bò đậm đà"),
                            new FoodMenuItem("r3_4", "Burger Yumm", 49000, R.drawable.img_food_chicken,
                                    "Burger bò phô mai")),
                    R.drawable.img_food_chicken, 4.8, 1500, 25, "Jollibee TTTM Vincom Dĩ An"));

            restaurants.add(new com.example.uitpayapp.home.home_models.Restaurant(21L, "Highlands\nCoffee", "HC",
                    android.graphics.Color.parseColor("#6F4E37"), "Cà phê\nTrà sữa", java.util.Arrays.asList(
                            new FoodMenuItem("r4_1", "Phin sữa đá", 39000, R.drawable.img_food_coffee,
                                    "Cà phê phin sữa đặc"),
                            new FoodMenuItem("r4_2", "Freeze trà xanh", 55000, R.drawable.img_food_bubbletea,
                                    "Trà xanh đá xay"),
                            new FoodMenuItem("r4_3", "Bánh mì thịt nguội", 35000, R.drawable.img_food_chicken,
                                    "Bánh mì kiểu Việt"),
                            new FoodMenuItem("r4_4", "Freeze sô-cô-la", 55000, R.drawable.img_food_coffee,
                                    "Sô-cô-la đá xay kem")),
                    R.drawable.img_food_coffee, 4.5, 750, 15, "Highlands Vincom Thủ Đức"));

            restaurants.add(new com.example.uitpayapp.home.home_models.Restaurant(901L, "TEXAS\nCHICKEN", "TX",
                    android.graphics.Color.parseColor("#FF6900"), "Gà rán\nBurger", java.util.Arrays.asList(
                            new FoodMenuItem("r5_1", "Gà rán Texas 1 miếng", 42000, R.drawable.img_food_chicken,
                                    "Gà giòn kiểu Texas"),
                            new FoodMenuItem("r5_2", "Combo Texas Big", 99000, R.drawable.img_food_chicken,
                                    "3 miếng gà + khoai + nước"),
                            new FoodMenuItem("r5_3", "Burger gà cay", 45000, R.drawable.img_food_chicken,
                                    "Burger gà sốt cay"),
                            new FoodMenuItem("r5_4", "Khoai tây chiên", 25000, R.drawable.img_food_pizza,
                                    "Khoai tây giòn tan")),
                    R.drawable.img_food_chicken, 4.6, 620, 25, "Texas Chicken Pearl Plaza"));

            restaurants.add(new com.example.uitpayapp.home.home_models.Restaurant(902L, "MAYCHA", "MC",
                    android.graphics.Color.parseColor("#FF69B4"), "Cà phê\nTrà sữa", java.util.Arrays.asList(
                            new FoodMenuItem("r6_1", "Trà sữa truyền thống", 35000, R.drawable.img_food_bubbletea,
                                    "Trà sữa trân châu đường đen"),
                            new FoodMenuItem("r6_2", "Trà sữa matcha", 45000, R.drawable.img_food_bubbletea,
                                    "Matcha Nhật Bản"),
                            new FoodMenuItem("r6_3", "Trà đào", 40000, R.drawable.img_food_bubbletea,
                                    "Trà đào tươi mát"),
                            new FoodMenuItem("r6_4", "Sữa tươi trân châu", 38000, R.drawable.img_food_bubbletea,
                                    "Sữa tươi + trân châu đen")),
                    R.drawable.img_food_bubbletea, 4.9, 2100, 15, "MAYCHA Đặng Văn Bi"));

            restaurants.add(new com.example.uitpayapp.home.home_models.Restaurant(903L, "Burger\nKing", "BK",
                    android.graphics.Color.parseColor("#FF8C00"), "Gà rán\nBurger", java.util.Arrays.asList(
                            new FoodMenuItem("r7_1", "Whopper", 79000, R.drawable.img_food_chicken,
                                    "Burger bò nướng lửa cỡ lớn"),
                            new FoodMenuItem("r7_2", "Combo Whopper", 109000, R.drawable.img_food_chicken,
                                    "Whopper + khoai + nước"),
                            new FoodMenuItem("r7_3", "Chicken Nuggets 6pc", 45000, R.drawable.img_food_chicken,
                                    "6 miếng gà viên chiên"),
                            new FoodMenuItem("r7_4", "Onion Rings", 35000, R.drawable.img_food_pizza,
                                    "Hành tây chiên giòn")),
                    R.drawable.img_food_chicken, 4.3, 350, 30, "Burger King Nguyễn Duy Trinh"));

            restaurants.add(new com.example.uitpayapp.home.home_models.Restaurant(904L, "Domino's\nPizza", "DP",
                    android.graphics.Color.parseColor("#006491"), "Cơm\nPizza", java.util.Arrays.asList(
                            new FoodMenuItem("r8_1", "Pizza Hải sản Pesto", 169000, R.drawable.img_food_pizza,
                                    "Pizza hải sản sốt pesto"),
                            new FoodMenuItem("r8_2", "Pizza Pepperoni", 149000, R.drawable.img_food_pizza,
                                    "Pizza pepperoni cổ điển"),
                            new FoodMenuItem("r8_3", "Gà viên phô mai", 59000, R.drawable.img_food_chicken,
                                    "Gà viên nhân phô mai"),
                            new FoodMenuItem("r8_4", "Khoai tây xoắn", 49000, R.drawable.img_food_pizza,
                                    "Khoai tây xoắn giòn")),
                    R.drawable.img_food_pizza, 4.7, 890, 35, "Domino's Pizza Q2"));

            restaurants.add(new com.example.uitpayapp.home.home_models.Restaurant(905L, "Tous Les\nJours", "TJ",
                    android.graphics.Color.parseColor("#C62828"), "Bánh\nKem", java.util.Arrays.asList(
                            new FoodMenuItem("r9_1", "Bánh kem dâu tây", 189000, R.drawable.img_food_pizza,
                                    "Bánh kem tươi vị dâu"),
                            new FoodMenuItem("r9_2", "Bánh mì bơ tỏi", 25000, R.drawable.img_food_chicken,
                                    "Bánh mì nướng bơ tỏi giòn"),
                            new FoodMenuItem("r9_3", "Croissant trứng muối", 35000, R.drawable.img_food_chicken,
                                    "Croissant nhân trứng muối"),
                            new FoodMenuItem("r9_4", "Bánh su kem", 29000, R.drawable.img_food_bubbletea,
                                    "Bánh su kem tươi mát")),
        ...
        public java.util.List<Object[]> getTopics() {
            ...
            topicPool.add(new Object[] { "Xôi", "Nóng hổi, dẻo thơm mỗi sáng", java.util.Arrays.asList(
                    new FoodMenuItem("t1_1", "Xôi loại 1", 25000, R.drawable.img_food_chicken,
                            "Món xôi chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t1_2", "Xôi loại 2", 35000, R.drawable.img_food_chicken,
                            "Món xôi chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t1_3", "Xôi loại 3", 45000, R.drawable.img_food_chicken,
                            "Món xôi chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t1_4", "Xôi loại 4", 55000, R.drawable.img_food_chicken,
                            "Món xôi chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t1_5", "Xôi loại 5", 65000, R.drawable.img_food_chicken,
                            "Món xôi chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Thức ăn khác", "Khám phá đa dạng các món ngon", java.util.Arrays.asList(
                    new FoodMenuItem("t2_1", "Thức ăn khác loại 1", 25000, R.drawable.img_food_pizza,
                            "Món thức ăn khác chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t2_2", "Thức ăn khác loại 2", 35000, R.drawable.img_food_pizza,
                            "Món thức ăn khác chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t2_3", "Thức ăn khác loại 3", 45000, R.drawable.img_food_pizza,
                            "Món thức ăn khác chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t2_4", "Thức ăn khác loại 4", 55000, R.drawable.img_food_pizza,
                            "Món thức ăn khác chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t2_5", "Thức ăn khác loại 5", 65000, R.drawable.img_food_pizza,
                            "Món thức ăn khác chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Trà", "Thanh mát, giải nhiệt ngày hè", java.util.Arrays.asList(
                    new FoodMenuItem("t3_1", "Trà loại 1", 25000, R.drawable.img_food_bubbletea,
                            "Món trà chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t3_2", "Trà loại 2", 35000, R.drawable.img_food_bubbletea,
                            "Món trà chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t3_3", "Trà loại 3", 45000, R.drawable.img_food_bubbletea,
                            "Món trà chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t3_4", "Trà loại 4", 55000, R.drawable.img_food_bubbletea,
                            "Món trà chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t3_5", "Trà loại 5", 65000, R.drawable.img_food_bubbletea,
                            "Món trà chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Sữa", "Dinh dưỡng tuyệt vời cho cơ thể", java.util.Arrays.asList(
                    new FoodMenuItem("t4_1", "Sữa loại 1", 25000, R.drawable.img_food_bubbletea,
                            "Món sữa chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t4_2", "Sữa loại 2", 35000, R.drawable.img_food_bubbletea,
                            "Món sữa chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t4_3", "Sữa loại 3", 45000, R.drawable.img_food_bubbletea,
                            "Món sữa chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t4_4", "Sữa loại 4", 55000, R.drawable.img_food_bubbletea,
                            "Món sữa chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t4_5", "Sữa loại 5", 65000, R.drawable.img_food_bubbletea,
                            "Món sữa chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Nước ngọt", "Giải khát tức thì, bùng nổ sảng khoái", java.util.Arrays.asList(
                    new FoodMenuItem("t5_1", "Nước ngọt loại 1", 25000, R.drawable.img_food_bubbletea,
                            "Món nước ngọt chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t5_2", "Nước ngọt loại 2", 35000, R.drawable.img_food_bubbletea,
                            "Món nước ngọt chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t5_3", "Nước ngọt loại 3", 45000, R.drawable.img_food_bubbletea,
                            "Món nước ngọt chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t5_4", "Nước ngọt loại 4", 55000, R.drawable.img_food_bubbletea,
                            "Món nước ngọt chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t5_5", "Nước ngọt loại 5", 65000, R.drawable.img_food_bubbletea,
                            "Món nước ngọt chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Nước ép trái cây - Sinh tố", "Tươi ngon, bổ sung vitamin",
                    java.util.Arrays.asList(
                            new FoodMenuItem("t6_1", "Nước ép trái cây - Sinh tố loại 1", 25000,
                                    R.drawable.img_food_bubbletea,
                                    "Món nước ép trái cây - sinh tố chuẩn vị, ngon miệng"),
                            new FoodMenuItem("t6_2", "Nước ép trái cây - Sinh tố loại 2", 35000,
                                    R.drawable.img_food_bubbletea,
                                    "Món nước ép trái cây - sinh tố chuẩn vị, ngon miệng"),
                            new FoodMenuItem("t6_3", "Nước ép trái cây - Sinh tố loại 3", 45000,
                                    R.drawable.img_food_bubbletea,
                                    "Món nước ép trái cây - sinh tố chuẩn vị, ngon miệng"),
                            new FoodMenuItem("t6_4", "Nước ép trái cây - Sinh tố loại 4", 55000,
                                    R.drawable.img_food_bubbletea,
                                    "Món nước ép trái cây - sinh tố chuẩn vị, ngon miệng"),
                            new FoodMenuItem("t6_5", "Nước ép trái cây - Sinh tố loại 5", 65000,
                                    R.drawable.img_food_bubbletea,
                                    "Món nước ép trái cây - sinh tố chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Mì ăn liền", "Nhanh gọn, cứu đói đêm khuya", java.util.Arrays.asList(
                    new FoodMenuItem("t7_1", "Mì ăn liền loại 1", 25000, R.drawable.img_food_pizza,
                            "Món mì ăn liền chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t7_2", "Mì ăn liền loại 2", 35000, R.drawable.img_food_pizza,
                            "Món mì ăn liền chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t7_3", "Mì ăn liền loại 3", 45000, R.drawable.img_food_pizza,
                            "Món mì ăn liền chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t7_4", "Mì ăn liền loại 4", 55000, R.drawable.img_food_pizza,
                            "Món mì ăn liền chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t7_5", "Mì ăn liền loại 5", 65000, R.drawable.img_food_pizza,
                            "Món mì ăn liền chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Lẩu", "Quây quần bên bạn bè, ấm áp mùa đông", java.util.Arrays.asList(
                    new FoodMenuItem("t8_1", "Lẩu loại 1", 25000, R.drawable.img_food_pizza,
                            "Món lẩu chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t8_2", "Lẩu loại 2", 35000, R.drawable.img_food_pizza,
                            "Món lẩu chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t8_3", "Lẩu loại 3", 45000, R.drawable.img_food_pizza,
                            "Món lẩu chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t8_4", "Lẩu loại 4", 55000, R.drawable.img_food_pizza,
                            "Món lẩu chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t8_5", "Lẩu loại 5", 65000, R.drawable.img_food_pizza,
                            "Món lẩu chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Hải sản", "Tôm cua cá mực, tươi ngon mỗi ngày", java.util.Arrays.asList(
                    new FoodMenuItem("t9_1", "Hải sản loại 1", 25000, R.drawable.img_food_pizza,
                            "Món hải sản chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t9_2", "Hải sản loại 2", 35000, R.drawable.img_food_pizza,
                            "Món hải sản chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t9_3", "Hải sản loại 3", 45000, R.drawable.img_food_pizza,
                            "Món hải sản chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t9_4", "Hải sản loại 4", 55000, R.drawable.img_food_pizza,
                            "Món hải sản chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t9_5", "Hải sản loại 5", 65000, R.drawable.img_food_pizza,
                            "Món hải sản chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Fastfood", "Tiện lợi, nhanh chóng, ngon miệng", java.util.Arrays.asList(
                    new FoodMenuItem("t10_1", "Fastfood loại 1", 25000, R.drawable.img_food_chicken,
                            "Món fastfood chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t10_2", "Fastfood loại 2", 35000, R.drawable.img_food_chicken,
                            "Món fastfood chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t10_3", "Fastfood loại 3", 45000, R.drawable.img_food_chicken,
                            "Món fastfood chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t10_4", "Fastfood loại 4", 55000, R.drawable.img_food_chicken,
                            "Món fastfood chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t10_5", "Fastfood loại 5", 65000, R.drawable.img_food_chicken,
                            "Món fastfood chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Đồ nướng", "Xèo xèo thơm lừng, đậm đà gia vị", java.util.Arrays.asList(
                    new FoodMenuItem("t11_1", "Đồ nướng loại 1", 25000, R.drawable.img_food_chicken,
                            "Món đồ nướng chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t11_2", "Đồ nướng loại 2", 35000, R.drawable.img_food_chicken,
                            "Món đồ nướng chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t11_3", "Đồ nướng loại 3", 45000, R.drawable.img_food_chicken,
                            "Món đồ nướng chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t11_4", "Đồ nướng loại 4", 55000, R.drawable.img_food_chicken,
                            "Món đồ nướng chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t11_5", "Đồ nướng loại 5", 65000, R.drawable.img_food_chicken,
                            "Món đồ nướng chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Đồ chay", "Thanh tịnh, nhẹ nhàng, tốt cho sức khỏe", java.util.Arrays.asList(
                    new FoodMenuItem("t12_1", "Đồ chay loại 1", 25000, R.drawable.img_food_pizza,
                            "Món đồ chay chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t12_2", "Đồ chay loại 2", 35000, R.drawable.img_food_pizza,
                            "Món đồ chay chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t12_3", "Đồ chay loại 3", 45000, R.drawable.img_food_pizza,
                            "Món đồ chay chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t12_4", "Đồ chay loại 4", 55000, R.drawable.img_food_pizza,
                            "Món đồ chay chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t12_5", "Đồ chay loại 5", 65000, R.drawable.img_food_pizza,
                            "Món đồ chay chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Gỏi - Cuốn - Salad", "Tươi mát, healthy, đầy đủ dưỡng chất",
                    java.util.Arrays.asList(
                            new FoodMenuItem("t13_1", "Gỏi - Cuốn - Salad loại 1", 25000, R.drawable.img_food_pizza,
                                    "Món gỏi - cuốn - salad chuẩn vị, ngon miệng"),
                            new FoodMenuItem("t13_2", "Gỏi - Cuốn - Salad loại 2", 35000, R.drawable.img_food_pizza,
                                    "Món gỏi - cuốn - salad chuẩn vị, ngon miệng"),
                            new FoodMenuItem("t13_3", "Gỏi - Cuốn - Salad loại 3", 45000, R.drawable.img_food_pizza,
                                    "Món gỏi - cuốn - salad chuẩn vị, ngon miệng"),
                            new FoodMenuItem("t13_4", "Gỏi - Cuốn - Salad loại 4", 55000, R.drawable.img_food_pizza,
                                    "Món gỏi - cuốn - salad chuẩn vị, ngon miệng"),
                            new FoodMenuItem("t13_5", "Gỏi - Cuốn - Salad loại 5", 65000, R.drawable.img_food_pizza,
                                    "Món gỏi - cuốn - salad chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Cơm", "Bữa cơm ấm bụng, giá cả phải chăng", java.util.Arrays.asList(
                    new FoodMenuItem("t14_1", "Cơm loại 1", 25000, R.drawable.img_food_chicken,
                            "Món cơm chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t14_2", "Cơm loại 2", 35000, R.drawable.img_food_chicken,
                            "Món cơm chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t14_3", "Cơm loại 3", 45000, R.drawable.img_food_chicken,
                            "Món cơm chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t14_4", "Cơm loại 4", 55000, R.drawable.img_food_chicken,
                            "Món cơm chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t14_5", "Cơm loại 5", 65000, R.drawable.img_food_chicken,
                            "Món cơm chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Cháo", "Nóng hổi, dễ tiêu, bổ dưỡng", java.util.Arrays.asList(
                    new FoodMenuItem("t15_1", "Cháo loại 1", 25000, R.drawable.img_food_chicken,
                            "Món cháo chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t15_2", "Cháo loại 2", 35000, R.drawable.img_food_chicken,
                            "Món cháo chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t15_3", "Cháo loại 3", 45000, R.drawable.img_food_chicken,
                            "Món cháo chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t15_4", "Cháo loại 4", 55000, R.drawable.img_food_chicken,
                            "Món cháo chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t15_5", "Cháo loại 5", 65000, R.drawable.img_food_chicken,
                            "Món cháo chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Cafe", "Đánh thức tinh thần, bắt đầu ngày mới", java.util.Arrays.asList(
                    new FoodMenuItem("t16_1", "Cafe loại 1", 25000, R.drawable.img_food_coffee,
                            "Món cafe chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t16_2", "Cafe loại 2", 35000, R.drawable.img_food_coffee,
                            "Món cafe chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t16_3", "Cafe loại 3", 45000, R.drawable.img_food_coffee,
                            "Món cafe chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t16_4", "Cafe loại 4", 55000, R.drawable.img_food_coffee,
                            "Món cafe chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t16_5", "Cafe loại 5", 65000, R.drawable.img_food_coffee,
                            "Món cafe chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Bún - Phở - Hủ tiếu", "Top món ăn truyền thống được yêu thích",
                    java.util.Arrays.asList(
                            new FoodMenuItem("t17_1", "Bún - Phở - Hủ tiếu loại 1", 25000, R.drawable.img_food_chicken,
                                    "Món bún - phở - hủ tiếu chuẩn vị, ngon miệng"),
                            new FoodMenuItem("t17_2", "Bún - Phở - Hủ tiếu loại 2", 35000, R.drawable.img_food_chicken,
                                    "Món bún - phở - hủ tiếu chuẩn vị, ngon miệng"),
                            new FoodMenuItem("t17_3", "Bún - Phở - Hủ tiếu loại 3", 45000, R.drawable.img_food_chicken,
                                    "Món bún - phở - hủ tiếu chuẩn vị, ngon miệng"),
                            new FoodMenuItem("t17_4", "Bún - Phở - Hủ tiếu loại 4", 55000, R.drawable.img_food_chicken,
                                    "Món bún - phở - hủ tiếu chuẩn vị, ngon miệng"),
                            new FoodMenuItem("t17_5", "Bún - Phở - Hủ tiếu loại 5", 65000, R.drawable.img_food_chicken,
                                    "Món bún - phở - hủ tiếu chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Bia rượu", "Chill cùng bạn bè ngày cuối tuần", java.util.Arrays.asList(
                    new FoodMenuItem("t18_1", "Bia rượu loại 1", 25000, R.drawable.img_food_bubbletea,
                            "Món bia rượu chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t18_2", "Bia rượu loại 2", 35000, R.drawable.img_food_bubbletea,
                            "Món bia rượu chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t18_3", "Bia rượu loại 3", 45000, R.drawable.img_food_bubbletea,
                            "Món bia rượu chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t18_4", "Bia rượu loại 4", 55000, R.drawable.img_food_bubbletea,
                            "Món bia rượu chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t18_5", "Bia rượu loại 5", 65000, R.drawable.img_food_bubbletea,
                            "Món bia rượu chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Bánh mì", "Ổ bánh mì nóng giòn, đậm đà hương vị", java.util.Arrays.asList(
                    new FoodMenuItem("t19_1", "Bánh mì loại 1", 25000, R.drawable.img_food_chicken,
                            "Món bánh mì chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t19_2", "Bánh mì loại 2", 35000, R.drawable.img_food_chicken,
                            "Món bánh mì chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t19_3", "Bánh mì loại 3", 45000, R.drawable.img_food_chicken,
                            "Món bánh mì chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t19_4", "Bánh mì loại 4", 55000, R.drawable.img_food_chicken,
                            "Món bánh mì chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t19_5", "Bánh mì loại 5", 65000, R.drawable.img_food_chicken,
                            "Món bánh mì chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Bánh ngọt", "Ngọt ngào, xoa dịu mọi muộn phiền", java.util.Arrays.asList(
                    new FoodMenuItem("t20_1", "Bánh ngọt loại 1", 25000, R.drawable.img_food_bubbletea,
                            "Món bánh ngọt chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t20_2", "Bánh ngọt loại 2", 35000, R.drawable.img_food_bubbletea,
                            "Món bánh ngọt chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t20_3", "Bánh ngọt loại 3", 45000, R.drawable.img_food_bubbletea,
                            "Món bánh ngọt chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t20_4", "Bánh ngọt loại 4", 55000, R.drawable.img_food_bubbletea,
                            "Món bánh ngọt chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t20_5", "Bánh ngọt loại 5", 65000, R.drawable.img_food_bubbletea,
                            "Món bánh ngọt chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Bánh bao", "Mềm xốp, nhân đậm đà", java.util.Arrays.asList(
                    new FoodMenuItem("t21_1", "Bánh bao loại 1", 25000, R.drawable.img_food_chicken,
                            "Món bánh bao chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t21_2", "Bánh bao loại 2", 35000, R.drawable.img_food_chicken,
                            "Món bánh bao chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t21_3", "Bánh bao loại 3", 45000, R.drawable.img_food_chicken,
                            "Món bánh bao chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t21_4", "Bánh bao loại 4", 55000, R.drawable.img_food_chicken,
                            "Món bánh bao chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t21_5", "Bánh bao loại 5", 65000, R.drawable.img_food_chicken,
                            "Món bánh bao chuẩn vị, ngon miệng")) });
            topicPool.add(new Object[] { "Ăn vặt", "Món ngon đường phố, nhớ mãi không quên", java.util.Arrays.asList(
                    new FoodMenuItem("t22_1", "Ăn vặt loại 1", 25000, R.drawable.img_food_pizza,
                            "Món ăn vặt chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t22_2", "Ăn vặt loại 2", 35000, R.drawable.img_food_pizza,
                            "Món ăn vặt chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t22_3", "Ăn vặt loại 3", 45000, R.drawable.img_food_pizza,
                            "Món ăn vặt chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t22_4", "Ăn vặt loại 4", 55000, R.drawable.img_food_pizza,
                            "Món ăn vặt chuẩn vị, ngon miệng"),
                    new FoodMenuItem("t22_5", "Ăn vặt loại 5", 65000, R.drawable.img_food_pizza,
                            "Món ăn vặt chuẩn vị, ngon miệng")) });
