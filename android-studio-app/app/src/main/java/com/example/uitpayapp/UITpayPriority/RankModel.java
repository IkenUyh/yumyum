...
public class RankModel {
    public enum RankType {
        NEW("TÀI KHOẢN MỚI", "#10a941", "Hạng Thành viên", 0, Arrays.asList(
                ...
                new MenuItemData("Dùng Xu đổi voucher hot", "Voucher giảm đến 50% siêu hot", R.drawable.ic_accmulated_balance, false),
        ...
        SILVER("HẠNG BẠC", "#839bcb", "🥈 Hạng Bạc", 3000000, Arrays.asList(
                ...
                new MenuItemData("Dùng Xu đổi voucher hot", "Nhiều deal xịn dành riêng hạng Bạc", R.drawable.ic_accmulated_balance, false),
                new MenuItemData("Nhận ngay 1 Xu", "Với mỗi 5.000đ thanh toán", R.drawable.ic_qr, false),
                new MenuItemData("Nhận x2 Xu khi thanh toán", "Bằng Số Dư Sinh Lời hoặc Tài Khoản Trả Sau", R.drawable.ic_accmulated_balance, false),
        ...
        GOLD("HẠNG VÀNG", "#bfad3d", "🥇 Hạng Vàng", 18000000, Arrays.asList(
                ...
                new MenuItemData("Dùng Xu đổi voucher hot", "Nhiều voucher giảm 50% cho hạng Vàng", R.drawable.ic_accmulated_balance, false),
        ...
        DIAMOND("HẠNG KIM CƯƠNG", "#0d1e3c", "💎 Hạng Kim cương", 60000000, Arrays.asList(
                ...
                new MenuItemData("Dùng Xu đổi voucher hot", "+1000 voucher xịn cho hạng Kim Cương", R.drawable.ic_accmulated_balance, false),
